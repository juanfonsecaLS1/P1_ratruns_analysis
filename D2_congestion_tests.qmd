...
t_thresholds = seq(1,25,2)*60

grid_test <- expand_grid(v = seq(3, 30, 3),
                         th = t_thresholds)
...
save(test_centralities_threshold,file = "sf_network/test_cent_thresholds.rdata")
```
...
tidy_test |>
  mutate(across(wwd.speed:dist.th,as.integer)) |> 
write_csv(file = "sf_network/cent_tests.csv")
```
